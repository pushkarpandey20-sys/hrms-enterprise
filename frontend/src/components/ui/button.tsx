...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        default: 'bg-gradient-to-r from-electric to-indigo-600 text-white shadow-glow hover:from-electric-dark hover:to-indigo-700',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline: 'border border-white/20 bg-transparent text-foreground hover:bg-white/[0.06]',
        ...
        gold: 'bg-gradient-to-r from-gold to-amber-500 text-white hover:from-amber-600 hover:to-amber-600',
      },
      size: {
