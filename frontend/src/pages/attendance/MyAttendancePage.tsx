...
main
  ...
  const clockInMutation = useMutation({
    ...
    onError: (err: any) => {
      toast({ title: 'Error', description: err.response?.data?.message || 'Clock-in failed', variant: 'destructive' });
    },
  });
  ...
  const clockOutMutation = useMutation({
    ...
    onSuccess: () => {
      toast({ title: 'Clocked Out', description: 'Clock-out recorded successfully.' });
      qc.invalidateQueries({ queryKey: ['attendance'] });
      closeCamera();
    },
    onError: (err: any) => {
      toast({ title: 'Error', description: err.response?.data?.message || 'Clock-out failed', variant: 'destructive' });
    },
  });
